<div id="modalContainer" class="modal-block modal-block-primary">
    <section class="card">
        ...
        <div class="card-body">
            ...
            <input type="hidden" name="v_id_type" id="v_id_type" value="<?= isset($dMaster->id_type) ? base64_encode($dMaster->id_type) : '' ?>">
            <div class="form-group row">
                <label class="col-sm-3 control-label text-sm-right pt-2">Type Name <span class="required">*</span></label>
                <div class="col-sm-8">
                    <input name="v_name_type" id="v_name_type" value="<?= isset($dMaster->name_type) ? $dMaster->name_type : '' ?>" type="text" class="form-control" required>
                </div>
            </div>            
