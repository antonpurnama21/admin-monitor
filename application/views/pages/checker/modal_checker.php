    ...
    <section class="card">
        ...
        <div class="card-body">
            ...
            <label class="col-lg-3 control-label text-lg-right pt-2">Date</label>
                <div class="col-lg-8">
                    <div class="input-group">
                        ...
                        <input type="text" autocomplete="off" name="date_test" value="<?=($dMaster->date != '0000-00-00') ? date_format(date_create($dMaster->date), 'd-m-Y') : ''?>" class="form-control pickadate">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="number" id="day_estimate" value="<?= (isset($dMaster->estimated_day)) ? $dMaster->estimated_day : '' ?>" name="day_estimate" class="form-control">
                </div>
            </div>
            <div class="form-group row">
