...
<!-- <a class="btn btn-default btn-xs" onclick="confirms('Delete','Document Form `<?=$key->name_form ?>`?','<?=base_url('testcase/delete_form') ?>','<?=base64_encode($key->id_ms_form)?>')"><i class="icon-trash"></i></a> -->