<div id="modalContainer" class="modal-block modal-block-primary">
    <section class="card">
        ...
        <div class="card-body">
            ...
            <input type="hidden" name="id_device" id="id_device" value="<?= isset($dMaster->id_device) ? base64_encode($dMaster->id_device) : '' ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input name="device_name" id="device_name" value="<?= isset($dMaster->device_name) ? $dMaster->device_name : '' ?>" type="text" class="form-control" required>
                </div>
            </div>            
