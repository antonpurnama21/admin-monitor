<div id="modalContainer" class="modal-block modal-block-primary">
    <section class="card">
        ...
        <div class="card-body">
            ...
            <input type="hidden" name="id_role" id="id_role" value="<?= isset($dMaster->id_role) ? base64_encode($dMaster->id_role) : '' ?>">
            <div class="form-group row">
                <label class="col-sm-3 control-label text-sm-right pt-2">Role Name <span class="required">*</span></label>
                <div class="col-sm-8">
                    <input name="role" id="role" value="<?= isset($dMaster->role) ? $dMaster->role : '' ?>" type="text" class="form-control" required>
                </div>
            </div>            
